defmodule StructHelpers do
  ...
  such as a constructor, and getter / setter for each attribute. If the outlined typing criteria is not followed
  then and exception is raised.
